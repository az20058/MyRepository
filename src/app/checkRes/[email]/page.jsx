...
export default async function Email(props) {
    ...
    console.log(email);
    // const res = await axios.get(`http://localhost:8080/find/email/${email}`);
                ...
                return(
                    <div className="flightItem" key={index}>
                            ...
                            <div>
                                ...
                                <div><CheckSeat num={data.flightId} number={data.num}/></div>
                            </div>
                            <div>
                            ...
                            <div>
                                <span><Refund num={data.num} type={param.type}/></span>
                            </div>
                        </div>
                )
            })
