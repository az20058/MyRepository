          ...
          <div className="findFlight">  
            <div className="searchEmailWrapper">
              <div className="selectFindBy">
                <div className="selectedFind" onClick={()=>setSelectedFind("email")} style={selectedFind==="email"||!selectedFind?{backgroundColor:"#b0bec5"}:{backgroundColor:"white"}}>이메일로 찾기</div>
                <div className="selectedFind" onClick={()=>setSelectedFind("ID")} style={selectedFind==="email"||!selectedFind?{backgroundColor:"white"}:{backgroundColor:"#b0bec5"}}>예약코드로 찾기</div>
              </div>
              ...
              <div className="findByText">
                ...
                <Button onClick={handleClickEmail} variant="primary">검색</Button>{' '}
              </div>):(
              <div className="findByText">
                <input type="text" className="combo-input" placeholder="예약코드를 입력하세요" ref={IDRef}/> 
                <Button onClick={handleClickID} variant="primary">검색</Button>{' '}
              </div>)
              }
            </div>
          </div>
